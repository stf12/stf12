/**
  ******************************************************************************
  * @file    stm3220f_eval_audio_codec.h
...
#ifndef __STM3220F_EVAL_AUDIOCODEC_H
#define __STM3220F_EVAL_AUDIOCODEC_H

/* Includes ------------------------------------------------------------------*/
#include "stm32f2xx.h"
#include "stm3220f_eval_ioe.h" /* IOExpander driver is included in order to allow 
...
/* Uncomment the following line to use the default Codec_TIMEOUT_UserCallback() 
   function implemented in stm3220f_evel_audio_codec.c file.
...
/* I2C clock speed configuration (in Hz) 
  ...
  stm3220f_eval.h file). It can be used in parallel by other modules. */
#ifndef I2C_SPEED
...
#define CODEC_LONG_TIMEOUT             ((uint32_t)(100 * CODEC_FLAG_TIMEOUT))
/*----------------------------------------------------------------------------*/
...
/* Codec_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in stm3220F_evel_audio_codce.h file.
   Typically the user implementation of this callback should reset I2C peripheral
   and re-initialize communication or in worst case reset all the application. */
uint32_t Codec_TIMEOUT_UserCallback(void);
 
#endif /* __STM3220F_EVAL_AUDIOCODEC_H */
