...
public:
	...
	/**
	 * Constructor that add the managed task to the given context.
	 *
	 * @param pContext specifies a managed application context.
	 */
	AManagedTask(CMTContext *pContext);
	...
	/**
	 * Get the managed task context.
	 *
	 * @return the managed task context.
	 */
	CMTContext *GetContext() { return m_pContext; }
